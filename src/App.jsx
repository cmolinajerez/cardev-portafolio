        ...
        <div className="grid md:grid-cols-[320px_1fr] gap-8 items-start">
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-xl p-4 text-xs text-gray-400 w-full">
              ...
              <p className="text-center">Elige: <span className="text-white">⚡ Voz Rápida</span> o <span className="text-cyan-400">🎙️ Voz clonada en vivo</span></p>
            </div>
          </div>
            ...
            <div className="border-t border-white/20 p-2 md:p-4 bg-white/5">
              <div className="flex gap-1 md:gap-2">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-cyan-500 to-purple-500 p-2 md:p-3 rounded-xl hover:shadow-lg hover:shadow-cyan-500/50 transition disabled:opacity-50 disabled:cursor-not-allowed"
                >
